...
public class KTags {
    ...
    public static class ItemTags {
        ...
        private static TagKey<Item> tag(String name) {
            return TagKey.create(Registries.ITEM, new ResourceLocation(Kaleidoscopic.MOD_ID, name));
        }
    }
    public static class BlockTags {
        ...
        private static TagKey<Block> tag(String name) {
            return TagKey.create(Registries.BLOCK, new ResourceLocation(Kaleidoscopic.MOD_ID, name));
        }
