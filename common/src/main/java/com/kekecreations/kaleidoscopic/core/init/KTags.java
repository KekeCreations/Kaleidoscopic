...
public class KTags {
    ...
    public static class ItemTags {
        ...
        private static TagKey<Item> tag(String name) {
            return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Kaleidoscopic.MOD_ID, name));
        }
    }
    public static class BlockTags {
        ...
        private static TagKey<Block> tag(String name) {
            return TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Kaleidoscopic.MOD_ID, name));
        }
