...
public class KItemTagProvider extends FabricTagsProvider.ItemTagsProvider{


    public KItemTagProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture) {
    ...
    private void canCraftRock() {
        this.valueLookupBuilder(KTags.ItemTags.CAN_CRAFT_ROCK).setReplace(false)
    ...
    private void canCraftRockStairs() {
        this.valueLookupBuilder(KTags.ItemTags.CAN_CRAFT_ROCK_STAIRS).setReplace(false)
    ...
    private void canCraftRockSlab() {
        this.valueLookupBuilder(KTags.ItemTags.CAN_CRAFT_ROCK_SLAB).setReplace(false)
    ...
    private void canCraftRockWall() {
        this.valueLookupBuilder(KTags.ItemTags.CAN_CRAFT_ROCK_WALL).setReplace(false)
    ...
    private void canCraftDoor() {
        this.valueLookupBuilder(KTags.ItemTags.CAN_CRAFT_DOOR).setReplace(false)
                .addOptionalTag(ItemTags.WOODEN_DOORS);

    }

    private void canCraftTrapdoor() {
        this.valueLookupBuilder(KTags.ItemTags.CAN_CRAFT_TRAPDOOR).setReplace(false)
