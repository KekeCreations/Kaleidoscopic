...
public class KBlockLootTableProvider extends FabricBlockLootSubProvider {


    public KBlockLootTableProvider(FabricPackOutput packOutput, CompletableFuture<HolderLookup.Provider> registriesFuture) {
