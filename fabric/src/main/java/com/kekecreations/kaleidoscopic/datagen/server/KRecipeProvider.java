...
public class KRecipeProvider  extends FabricRecipeProvider {
    ...
    public KRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    protected static void bleachSquareRecipe(Ingredient craftingBlock, Item dyeColour, Block resultBlock, Consumer<FinishedRecipe> output) {
    ...
    protected static void dyeSquareRecipe(Ingredient craftingBlock, DyeColor dyeColour, Block resultBlock, Consumer<FinishedRecipe> output) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, resultBlock ,2)
                .pattern("XK")
                .pattern("KX")
                .define('K', craftingBlock)
    ...
    protected static void chiselRecipe(Block craftingBlock, Block resultBlock, Consumer<FinishedRecipe> recipeConsumer) {
